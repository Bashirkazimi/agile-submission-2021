...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(
		description='Predict and save outputs to shapefile by HRNet')
	...
	test_gen = utils.MultiData(conf.test_dir, test_files, conf.batch_size, False, dim=conf.dim, num_classes=conf.num_classes, return_filenames=True)
	...
	utils.make_predictions_and_vectorize_multiclass(model, test_gen, output_shp_file, conf.test_dir)
